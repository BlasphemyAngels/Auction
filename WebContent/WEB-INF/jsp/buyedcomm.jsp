...
<body>
	...
	<script>
		function doSearch(value, name) {
			...
			$('#commoditylist').datagrid({
				url : "${pageContext.request.contextPath }/BuyedCommJson?" + u
			})
	...
	<table id="commoditylist" class="easyui-datagrid" title="商品列表"
		...
		data-options="singleSelect:true,collapsible:true,url:'${pageContext.request.contextPath }/BuyedCommJson',method:'get',rownumbers:true,pagination:true,pageSize:10">
		<thead>
			<tr>
				<th data-options="field:'comm_id',width:70">商品ID</th>
				<th data-options="field:'title',width:140">商品标题</th>
