		...
		<div id="login">
			...
			<div id="mid" style="height: 200px;">
				<form id="loginform" style="padding-top: 0px;" method="post"
					...
					<div id="inpuser">
						<span id="usernameFont">用&nbsp;户&nbsp;名：</span><input type="text"
							id="username" name="username" value="${form.username }" /><span
							id="usernameSp" style="display: none">用户名不能为空！！！</span> <span
							class="Sp2"> <c:if test="${form!=null }">
					...
					<div id="inpsw">
						<span id="passwordFont">密&nbsp;&nbsp;&nbsp;&nbsp;码：</span><input
							...
							style="display: none">密码不能为空！！！ </span> <span class="Sp2">
							<c:if test="${form!=null }">
					...
					<div id="inpsw2">
						<span id="repeatPasswordFont">确认密码：</span><input
					...
					<div id="randomword">
						<span id="randomFont">验&nbsp;证&nbsp;码：</span><input type="text"
							name="ranomdWord"><img alt="换一张"
							src="${pageContext.request.contextPath }/GenerateRandomImage"
							onclick="changeImage(this)" style="cursor: hand" /> <span
							style="color: red;">${form.errors.ranomdWord }</span>
					</div>
					<div id="submit">
