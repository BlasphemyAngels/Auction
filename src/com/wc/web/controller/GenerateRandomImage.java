...
@WebServlet("/GenerateRandomImage")
public class GenerateRandomImage extends HttpServlet {
	/**
	 * 
	 */
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		response.setHeader("expires", "-1"); // 重要
		response.setHeader("Cache-Control", "no-cache");
		response.setHeader("progma", "no-cache");
		request.getSession().setAttribute("randomWord", randomWord);
